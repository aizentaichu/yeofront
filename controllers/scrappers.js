...
exports.findMeteoNCBySpot = function(req, res){
	...
	MeteoNC.find({'spot':spot}).sort({'update_date': -1}).limit(12).exec(function(err, result) {
		
		jsonForecastMeteoNC = {"forecast_meteonc" : result};
		return res.send(jsonForecastMeteoNC);
	});
